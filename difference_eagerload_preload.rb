...
In this example, Article.eager_load(:comments) will execute a single query using LEFT OUTER join to fetch all articles along with their associated comments. 
